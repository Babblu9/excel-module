/**
 * Cyncura OPEX Engine
 * Generates overhead projection costs like App Dev, Rent, Tech Support
 */

const CYNCURA_OPEX_INFLATION = {
    // Standard YoY inflation
    yearlyStepUps: {
        2: 0.10, // 10% YoY increase in costs
        3: 0.10,
        4: 0.15,
        5: 0.15,
    }
    ...
    for (let m = 0; m < totalMonths; m++) {
        ...
        if (m > 0) {
            ...
            if (yearIdx !== prevYearIdx) {
                const stepUp = CYNCURA_OPEX_INFLATION.yearlyStepUps[yearIdx] ?? 0;
