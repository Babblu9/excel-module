/**
 * Moorgen Revenue Engine
 */

const MOORGEN_REVENUE_GROWTH = {
    // Moorgen Franchisee model growth
    yearlyStepUps: {
        2: 0.15, // Y2->Y3: 15% increase in franchisee sales
        3: 0.15,
        4: 0.20,
        5: 0.20,
    },
    ...
    for (let m = 0; m < totalMonths; m++) {
        ...
        if (m > 0) {
            ...
            if (yearIdx !== prevYearIdx) {
                const stepUp = MOORGEN_REVENUE_GROWTH.yearlyStepUps[yearIdx] ?? 0;
